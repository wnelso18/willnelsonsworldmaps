...
m = leafmap.Map()
m.split_map(left_layer, right_layer)  # accepts folium TileLayer instances :contentReference[oaicite:1]{index=1}
m.add_colorbar(vis, label="Temp (°C)", layer_name="Land Temp")
